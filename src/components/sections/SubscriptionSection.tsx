...
const benefits = [
  "Unlimited access to empathetic chat sessions",
  "1-on-1 counsellor matching & confidential messaging",
  "Guided stress relief, anxiety & meditation tools",
  "24/7 instant listener availability & support",
  "Personalized mental wellness insights & mood tracking",
  "Ad-free, private & distraction-free experience",
];
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="max-w-3xl mx-auto">
          <AnimatedSection className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-rose-100/80 border border-rose-300/50 text-rose-900 font-semibold text-xs tracking-wide uppercase font-body mb-4">
          ...
          <AnimatedSection delay={0.2}>
            <div className="bg-card rounded-3xl border-2 border-rose-500/20 p-8 md:p-12 shadow-2xl relative overflow-hidden">
              {/* Highlight Badge */}
              <div className="absolute top-0 right-0 bg-gradient-to-l from-rose-600 to-pink-600 text-white text-xs font-extrabold uppercase px-6 py-1.5 rounded-bl-2xl tracking-wider shadow-md">
                3-Day Special Trial
              </div>
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-6 pb-8 mb-8 border-b border-border/80">
                <div>
                  <span className="text-xs font-bold uppercase tracking-widest text-rose-700 font-body block mb-1">
                    Introductory Offer
                  </span>
                  ...
                  <p className="text-sm font-medium text-rose-800 mt-1 font-body flex items-center gap-1.5">
                ...
                <div className="w-full md:w-auto text-center md:text-right">
                  <a href={PLAY_STORE_URL} target="_blank" rel="noopener noreferrer" className="block w-full md:w-auto">
                    <Button className="w-full md:w-auto rounded-full bg-rose-600 hover:bg-rose-700 text-white hover:scale-[1.03] transition-all shadow-lg px-8 py-6 text-base font-bold">
